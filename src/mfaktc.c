...
#include "selftest-data.h"
  ...
  unsigned int index[] = {   91, 27, 161, 2583, 646, 647, 648, 30,   25,   39,   57,   // some factors below 2^71 (test the 71/75 bit kernel depending on compute capability)
...
//      for (kernel_index = BARRETT82_MUL15; kernel_index <= BARRETT74_MUL15; ++kernel_index) // test only the 74-bit kernel
